...
- [x] **Run the weekly digest manually** — trigger `runWeeklyDigest()` with your user ID once in production to confirm emails send correctly from `reminders@yourhomewise.app`
